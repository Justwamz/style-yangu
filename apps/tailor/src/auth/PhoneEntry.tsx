...
const VALUE_PROPS = [
  'Clear design briefs — no more WhatsApp confusion',
  'Deposit protection through M-Pesa escrow',
  'Order tracking & measurement appointments',
]
...
export default function PhoneEntry() {
  ...
  async function handleSend() {
    ...
    setLoading(true)
    try {
      const res = await artisanApi.post<{ success: boolean; devCode?: string }>(
      ...
      <div className="bg-dark relative flex flex-col justify-between px-8 py-10 md:flex-1 md:py-16 md:px-14 overflow-hidden">
        ...
        <div className="py-10 md:py-0">
          ...
          <h1 className="font-display text-4xl md:text-5xl font-light text-white leading-[1.1] mb-8">
            Your craft,<br />
            <em className="italic text-gold">digitised.</em>
          </h1>
