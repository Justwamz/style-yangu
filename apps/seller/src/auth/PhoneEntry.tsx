...
export default function PhoneEntry() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-cream px-6">
      <h1 className="text-2xl font-bold font-display mb-1" style={{ color: '#8B4513' }}>Style Yangu Seller</h1>
      <p className="text-sm text-mid/70 mb-8">Enter your phone number to continue</p>
      <input
        type="tel"
        placeholder="+254 700 000 000"
        value={phone}
        onChange={e => setPhone(e.target.value)}
        className="w-full max-w-sm border border-sand rounded-lg px-4 py-3 text-base mb-2 focus:outline-none focus:ring-2 focus:ring-brand"
      />
